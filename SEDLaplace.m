function SEDLaplace(a,b,ciy,xi,t0)
...
tam=size(a);
tami=size(b);
syms y(t) Y(s) x(t) X(s) Yy Ys Xs Hs fp;
syms edd edi 
edd=0;
edi=0;
...
disp('=')
pretty(edi)
mensaje('LA FUNCIÓN DE TRANSFERENCIA DE LA ECUACIÓN DIFERENCIAL ES:')
edd1=collect(edd,Y(s));
edd1=subs(edd,Y(s),1);
edi1=subs(edi,X(s),1);
eq0=edi1/edd1;
disp('H(s)=')
